...
Last update: ``Wed Feb  4 14:36:31 2015``
...
![plot of chunk mTOR_DescriptiveH](figure/mTOR_DescriptiveH-1.png) ![plot of chunk mTOR_DescriptiveH](figure/mTOR_DescriptiveH-2.png) 
...
![plot of chunk mTOR_DescriptiveLevels](figure/mTOR_DescriptiveLevels-1.png) 
...
#### Tumor recurrence
![plot of chunk mTOR_AssociationRecurrence](figure/mTOR_AssociationRecurrence-1.png) 

|               | No |  %   | Yes | %  |
|:--------------|:--:|:----:|:---:|:--:|
|Low phos-mTOR  | 26 | 66.7 |  2  | 50 |
|High phos-mTOR | 13 | 33.3 |  2  | 50 |

***

#### Tumor progression
![plot of chunk mTOR_AssociationProgression](figure/mTOR_AssociationProgression-1.png) 

|               | No |  %   | Yes |  %   |
|:--------------|:--:|:----:|:---:|:----:|
|Low phos-mTOR  | 17 | 60.7 | 14  | 77.8 |
|High phos-mTOR | 11 | 39.3 |  4  | 22.2 |

***

#### Distant metastasis
![plot of chunk mTOR_AssociationDistantMetastasis](figure/mTOR_AssociationDistantMetastasis-1.png) 

|               | No | %  | Yes |  %   |
|:--------------|:--:|:--:|:---:|:----:|
|Low phos-mTOR  | 15 | 60 | 14  | 73.7 |
|High phos-mTOR | 10 | 40 |  5  | 26.3 |

***

#### Overall mortality
![plot of chunk mTOR_AssociationOverallMortality](figure/mTOR_AssociationOverallMortality-1.png) 

|               | No |  %   | Yes |  %   |
|:--------------|:--:|:----:|:---:|:----:|
|Low phos-mTOR  | 19 | 70.4 | 15  | 65.2 |
|High phos-mTOR | 8  | 29.6 |  8  | 34.8 |

***

#### Cancer-related mortality
![plot of chunk mTOR_AssociationCancerMortality](figure/mTOR_AssociationCancerMortality-1.png) 

|               | No | %  | Yes |  %   |
|:--------------|:--:|:--:|:---:|:----:|
|Low phos-mTOR  | 26 | 65 |  7  | 77.8 |
|High phos-mTOR | 14 | 35 |  2  | 22.2 |
...
![plot of chunk mTOR_SurvivalRecurrence](figure/mTOR_SurvivalRecurrence-1.png) 

|               | No. Observations | No. Events | Median Survival |
|:--------------|:----------------:|:----------:|:---------------:|
|Low phos-mTOR  |        2         |     2      |      31.35      |
|High phos-mTOR |        2         |     2      |      9.65       |

***

![plot of chunk mTOR_SurvivalProgression](figure/mTOR_SurvivalProgression-1.png) 

|               | No. Observations | No. Events | Median Survival |
|:--------------|:----------------:|:----------:|:---------------:|
|Low phos-mTOR  |        10        |     10     |      6.05       |
|High phos-mTOR |        4         |     4      |      10.80      |

***

![plot of chunk mTOR_SurvivalDistantMetastasis](figure/mTOR_SurvivalDistantMetastasis-1.png) 

|               | No. Observations | No. Events | Median Survival |
|:--------------|:----------------:|:----------:|:---------------:|
|Low phos-mTOR  |        6         |     6      |      9.45       |
|High phos-mTOR |        3         |     3      |      10.70      |

***

![plot of chunk mTOR_SurvivalOverallMortality](figure/mTOR_SurvivalOverallMortality-1.png) 

|               | No. Observations | No. Events | Median Survival |
|:--------------|:----------------:|:----------:|:---------------:|
|Low phos-mTOR  |        34        |     15     |      29.2       |
|High phos-mTOR |        16        |     8      |      56.6       |

***

![plot of chunk mTOR_SurvivalCancerMortality](figure/mTOR_SurvivalCancerMortality-1.png) 
...
|High phos-mTOR levels                       |  2.00   |     0.22     |     18.27     |     0.51    |       1.00       |
...
|High phos-mTOR levels                       |  0.44   |     0.10     |     1.61      |     0.23    |      0.9900      |
...
|High phos-mTOR levels                       |  0.54   |     0.14     |     1.91      |     0.35    |      1.000       |
...
|High phos-mTOR levels                       |  1.27   |     0.38     |     4.23      |      0.7    |       1.00       |
...
|High phos-mTOR levels                       |  0.53   |    0.072     |     2.56      |     0.47    |       1.00       |
...
|High phos-mTOR levels                       |  1.47   |     0.68     |     0.20      |     0.71    |       0.97       |
...
|High phos-mTOR levels                       |  0.49   |     2.06     |     0.16      |     0.18    |     5.4e-01      |
...
|High phos-mTOR levels                       |  0.65   |     1.55     |     0.23      |      0.4    |     5.6e-01      |
...
|High phos-mTOR levels                       |  0.73   |     1.38     |     0.29      |     0.48    |      0.930       |
...
|High pT stage (> pT1)                       |  3.62   |     0.28     |     0.75      |    0.079    |      0.5425      |
...
|High phos-mTOR levels                       |  0.46   |     2.19     |     0.094     |      0.3    |      0.8550      |
