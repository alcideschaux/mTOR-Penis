## mTOR in Penile Cancer: phos-AKT expression
Last update: ``Thu Dec 18 14:30:21 2014``
...
![plot of chunk AKT_DescriptiveH](figure/AKT_DescriptiveH1.png) ![plot of chunk AKT_DescriptiveH](figure/AKT_DescriptiveH2.png) 
...
![plot of chunk AKT_DescriptiveLevels](figure/AKT_DescriptiveLevels.png) 
...
#### Tumor recurrence
![plot of chunk AKT_AssociationRecurrence](figure/AKT_AssociationRecurrence.png) 

|              |  No  |  %   | Yes |  %   |
|:-------------|:----:|:----:|:---:|:----:|
|High phos-AKT | 6.0  | 15.4 | 1.0 | 25.0 |
|Low phos-AKT  | 33.0 | 84.6 | 3.0 | 75.0 |

***

#### Tumor progression
![plot of chunk AKT_AssociationProgression](figure/AKT_AssociationProgression.png) 

|              |  No  |  %   | Yes  |  %   |
|:-------------|:----:|:----:|:----:|:----:|
|High phos-AKT | 5.0  | 17.9 | 2.0  | 11.1 |
|Low phos-AKT  | 23.0 | 82.1 | 16.0 | 88.9 |

***

#### Distant metastasis
![plot of chunk AKT_AssociationDistantMetastasis](figure/AKT_AssociationDistantMetastasis.png) 

|              |  No  |  %   | Yes  |  %   |
|:-------------|:----:|:----:|:----:|:----:|
|High phos-AKT | 3.0  | 12.0 | 4.0  | 21.1 |
|Low phos-AKT  | 22.0 | 88.0 | 15.0 | 78.9 |

***

#### Overall mortality
![plot of chunk AKT_AssociationOverallMortality](figure/AKT_AssociationOverallMortality.png) 

|              |  No  |  %   | Yes  |  %   |
|:-------------|:----:|:----:|:----:|:----:|
|High phos-AKT | 6.0  | 22.2 | 1.0  | 4.3  |
|Low phos-AKT  | 21.0 | 77.8 | 22.0 | 95.7 |

***

#### Cancer-related mortality
![plot of chunk AKT_AssociationCancerMortality](figure/AKT_AssociationCancerMortality.png) 

|              |  No  |  %   | Yes |  %   |
|:-------------|:----:|:----:|:---:|:----:|
|High phos-AKT | 6.0  | 15.0 | 1.0 | 11.1 |
|Low phos-AKT  | 34.0 | 85.0 | 8.0 | 88.9 |
...
![plot of chunk AKT_SurvivalRecurrence](figure/AKT_SurvivalRecurrence.png) 

|              | No. Observations | No. Events | Median Survival |
|:-------------|:----------------:|:----------:|:---------------:|
|High phos-AKT |       1.0        |    1.0     |       8.3       |
|Low phos-AKT  |       3.0        |    3.0     |      18.3       |

***

![plot of chunk AKT_SurvivalProgression](figure/AKT_SurvivalProgression.png) 

|              | No. Observations | No. Events | Median Survival |
|:-------------|:----------------:|:----------:|:---------------:|
|High phos-AKT |       1.0        |    1.0     |      31.4       |
|Low phos-AKT  |       13.0       |    13.0    |       5.9       |

***

![plot of chunk AKT_SurvivalDistantMetastasis](figure/AKT_SurvivalDistantMetastasis.png) 

|              | No. Observations | No. Events | Median Survival |
|:-------------|:----------------:|:----------:|:---------------:|
|High phos-AKT |       1.0        |    1.0     |       1.3       |
|Low phos-AKT  |       8.0        |    8.0     |      11.2       |

***

![plot of chunk AKT_SurvivalOverallMortality](figure/AKT_SurvivalOverallMortality.png) 

|              | No. Observations | No. Events | Median Survival |
|:-------------|:----------------:|:----------:|:---------------:|
|High phos-AKT |       7.0        |    1.0     |       NA        |
|Low phos-AKT  |       43.0       |    22.0    |      56.6       |

***

![plot of chunk AKT_SurvivalCancerMortality](figure/AKT_SurvivalCancerMortality.png) 
...
|High phos-AKT levels                        |  0.55   |    0.057     |     12.05     |     0.62    |       1.00       |
...
|High phos-AKT levels                        |  1.74   |     0.33     |     13.21     |     0.54    |      0.9900      |
...
|High phos-AKT levels                        |  0.51   |     0.09     |     2.64      |     0.42    |      1.000       |
...
|High phos-AKT levels                        |  6.29   |     0.96     |    124.08     |      0.1    |       1.00       |
...
|High phos-AKT levels                        |  1.41   |     0.20     |     28.62     |     0.76    |       1.00       |
...
|High phos-AKT levels                        |  0.11   |     9.22     |     0.006     |     0.16    |       0.97       |
...
|High phos-AKT levels                        |  0.80   |     1.25     |     0.18      |     0.78    |     9.1e-01      |
...
|High phos-AKT levels                        |  0.47   |     2.11     |     0.13      |     0.29    |     5.6e-01      |
...
|High phos-AKT levels                        |  1.68   |     0.60     |     0.22      |     0.59    |      0.930       |
...
|Metastatic inguinal lymph nodes             |  2.63   |     0.38     |     0.62      |     0.18    |      0.9000      |
|High phos-AKT levels                        |  0.93   |     1.08     |     0.11      |     0.95    |      0.9500      |
